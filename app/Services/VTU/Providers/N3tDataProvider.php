...
class N3tDataProvider implements VTUProviderInterface
{
    ...
    {
        $this->baseUrl = rtrim(SystemSetting::get('n3tdata_base_url', env('N3TDATA_BASE_URL', 'https://n3tdata.com')), '/');
        $this->apiKey = SystemSetting::get('n3tdata_api_key', env('N3TDATA_API_KEY', ''));
    }
    ...
    public function verifyMeter(string $discoCode, string $meterNumber, string $type = 'prepaid'): array
    {
        return [
            ...
            'address'       => 'Verified via N3TData Gateway',
